...
pipe_clf3 = make_pipeline( RandomForestClassifier()) 
...
#                 'randomforestclassifier__max_depth':[3,5],
               'randomforestclassifier__n_estimators':[15,20,25,50,100,200,300,500],
...
gs = GridSearchCV(pipe_clf3, param_grid=param_grid, scoring='roc_auc_ovo', cv=4, return_train_score=True,refit=True)

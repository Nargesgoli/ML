...
param_grid = [{'mlpclassifier__hidden_layer_sizes':[3,5,10,12,15,20,25,30,50,75,100,150,200,300,500,1000,[3,3],[3,3,3],[5,5],[5,5,5],[10,10],[10,10,10]],
               'randomforestclassifier__activation'=['identity' , 'logistic', 'tanh', 'relu'],
               'randomforestclassifier__alpha':[0.000001,0.00001,0.0001,0.001,0.01, 1,10,100,500,100]}]
